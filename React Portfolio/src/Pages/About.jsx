  ...
  return (
    ...
    <div className='about-container'>
      ...
      <div className="btn-group">
        <a href="Bhuwan resume.pdf" download target="_blank"><button className="action-btn">Download Resume</button></a>
        ...
        <button className='action-btn' onClick={handlemore}>More</button>
          ...
          <div className='about-sec'>
            <li className='about-para'>
              Bachelor of Engineering in Electronics and Communication Engineering  |  M.Kumarasamy College of Engeneering  |  6.842 CGPA (Till 5th Semester)
            </li>
            <li className='about-para'>
